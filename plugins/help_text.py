    ...
    if update_channel:
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ  ᴄʜᴀɴɴᴇʟ', url='https://t.me/mukhushi_official'),
                    InlineKeyboardButton('ᴏᴡɴᴇʀ', url='https://t.me/itz_mst_boy')
                ],
                [
                    InlineKeyboardButton('ᴏᴛʜᴇʀ ʙᴏᴛs', url='https://t.me/moi_bot_lists/4'),
